...
temp = 23.5
print("Ex2")
print("Temperatura: 23.5",type (temp))
print("\n\n")
...
print("Ex4")
print("Parte Imaginária", numero.imag)
print("\n\n")
...
print("Ex5")
print("População: 8.000.000.000", type (populacao))
print("\n\n")
...
aprovado = True
print("Ex7")
print("Tipo do valor:",type(aprovado))
print ("\n\n")
...
print("Tipo do número:", type(soma))
print("\n\n")
...
print("Ex9")
print("Python não existe um valor máximo para números inteiros")
print("\n\n")
